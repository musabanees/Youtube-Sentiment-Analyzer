...
# create logs directory at project root (outside src)
project_root = Path(__file__).resolve().parents[3]  # src/<pkg>/data -> parents[3] is repo root
...
def main():
    try:
        # Define project root reliably. Assumes this script is in a top-level folder like 'pipelines' or 'scripts'.
        ...
        save_data(train_data, test_data, data_path=str(data_output_path))
